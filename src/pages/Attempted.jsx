...
const LoadingSpinner = () => (
    <div className="flex flex-col items-center justify-center h-64 text-gray-400">
        <svg
            className="animate-spin h-10 w-10 mb-4 text-cyan-500"
    ...
    return (
        <div className="flex flex-col items-center justify-center h-64 text-center bg-gray-800 p-8 rounded-xl">
            ...
            <p className="text-gray-400 mb-6">
                You haven't completed any tests yet. Let's change that!
            </p>
            <button
        ...
        return (
            <div className="space-y-5">
                {attempts.map((attempt) => {
                    const subjectName =
                        questionBank[attempt.subjectId]?.name ||
                        attempt.subjectId;
                    ...
                    return (
                        <div
                            key={attempt._id}
                            className="bg-gray-800 p-5 rounded-lg shadow-lg flex items-center justify-between transition-all hover:shadow-cyan-500/10 hover:ring-1 hover:ring-gray-700"
                        >
                            {/* Left Side: Info */}
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-400">
                                        Paper {attempt.paperId} • Completed on:{" "}
                                        {new Date(
                                            attempt.completedAt
                                        ).toLocaleDateString()}
                                    </p>
                ...
                <header className="flex items-center gap-4 mb-8 border-b-2 border-gray-700 pb-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-400">
                            Review your past performance and track your
                            progress.
                        </p>
                    </div>
                </header>
